...
tensorboard = TensorBoard(log_dir='runs', histogram_freq=0,
...
model.add(Dense(units = 128, kernel_initializer = 'uniform', activation = 'relu', input_dim = 56))
...
# Compiling the ANN
opt = keras.optimizers.Adam(Ilearning_rate=0.1, momentum = 0.9)
...
accuracies = cross_val_score(model, X[features], y, cv=10)
...
parameters = [{"n_estimators": [50, 100, 500], "bootstrap":[False, True], 
