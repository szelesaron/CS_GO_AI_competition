...
"""
FIRST NUMBER IS TOP LEFT X SECOND IS TOP RIGHT Y
"""
map_coords = {
    "de_cache":    (-2000, 3250),
    "de_dust2":    (-2476, 3239),
...
ct_sectors = sectors(last_positions_ct)  
t_sectors = sectors(last_positions_t) 
...
for index in range(1, 10):
    X["CTs_in_sector_"+str(index)] = sector_columns(ct_sectors)[index-1]
    X["Ts_in_sector_"+str(index)] = sector_columns(t_sectors)[index-1]
...
pistols = [ "Deagle", "P250", "Cz75Auto", 
           "FiveSeven", "Tec9", "Elite", "R8Revolver"]
default = ["UspS", "Glock", "P2000"]
other = ["ZeusX27"]

all_weapons = rifles + SMGs + heavy + pistols + default + other 
""" NUMBER OF TIMES A GIVEN WEAPON WAS OWNED AT THE BEGINNING OF A ROUND"""    
